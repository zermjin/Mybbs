		...
		<div class="fly-panel fly-panel-user" pad20>
			<div class="layui-tab layui-tab-brief" lay-filter="user">
				...
				<script type="text/javascript">
					...
					function mypass(){
						if(checkpass() && checkrepass()) return true;
						return false;
					}
					function checkpass() {
				...
				<div class="layui-tab-content" style="padding: 20px 0;">
					<div class="layui-form layui-form-pane layui-tab-item layui-show">
						<form method="post" action="../UserEditServlet" onsubmit="return checkemail();">
							<div class="layui-form-item">
								<label for="L_email" class="layui-form-label">邮箱</label>
								<div class="layui-input-inline">
									<input type="text" id="L_email" name="email" required
										lay-verify="email" autocomplete="off" value="${loginuser.email }"
										class="layui-input">
								</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" id="L_username" name="username" required
										lay-verify="required" autocomplete="off" value="${loginuser.nickname }"
										class="layui-input">
								</div>
								<div class="layui-inline">
									<div class="layui-input-inline">
										<input type="radio" name="sex" value="1" ${loginuser.sex==1 ?"checked":""} title="男">
										<input type="radio" name="sex" value="0" ${loginuser.sex==0 ?"checked":""} title="女">
									</div>
								</div>
							</div>
							<div class="layui-form-item">
								...
								<div class="layui-input-inline">
									<input type="text" id="L_city" name="city" autocomplete="off"
										value="${loginuser.city }" class="layui-input">
								</div>
							</div>
							<div class="layui-form-item layui-form-text">
								<label for="L_sign" class="layui-form-label">签名</label>
								<div class="layui-input-block">
									<textarea  id="L_sign" name="sign"
										autocomplete="off" class="layui-textarea" 
										style="height: 80px;">${loginuser.signName}</textarea>
								</div>
							</div>
							<div class="layui-form-item">
							<input type="submit" class="layui-btn" lay-filter="*" value="确认修改"></input>
					...
					<div class="layui-form layui-form-pane layui-tab-item">
						<form action="../UploadPictrueServlet?id=${loginuser.id }" method="post"  enctype="multipart/form-data">
						<div class="layui-form-item">
							<div class="avatar-add">
								<p>建议尺寸168*168，支持jpg、png、gif，最大不能超过30KB</p>
								<div class="up-img" >
									<input type="file" name="fileUpload" id="fileUpload" style="display: none;" onchange="uploadf();">
									<input type="button"  id="imgUpload" value="上传头像" class="layui-btn" onclick="showFileup();">
								</div>
								<img src="${pageContext.request.contextPath }/upload/${loginuser.headUrl}">
								<span class="loading"></span>
							</div>
							<br>
							<input id="Upload" type="submit" class="layui-btn" lay-filter="*" value="确认修改" style="display: none;"></input>
						</div>
						</form>
					</div>

					<div class="layui-form layui-form-pane layui-tab-item">
						<form action="../PasswordEditServlet?id=${loginuser.id }" method="post" onsubmit="return mypass();">
							<div class="layui-form-item">
